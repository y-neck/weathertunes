...
<main class="px-[6%] font-bold pt-[2%]">
    ...
    <div id="main-box" class="flex flex-col gap-0 w-full">
                <div id="weather-desc-box" class="rounded-t-lg h-[10vh] bg-gray-200">Sonnig</div>
                <div id="weather-icon-box" class="rounded-b-lg h-[10vh] bg-gray-300">Icon Wetter</div>
    </div>
</main>
